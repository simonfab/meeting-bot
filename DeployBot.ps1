...
aws ecs update-service --no-cli-pager --cluster helloworld3-cluster --service meeting-bot-1  --force-new-deployment | Out-Null
aws ecs update-service --no-cli-pager --cluster helloworld3-cluster --service meeting-bot-2  --force-new-deployment | Out-Null
aws ecs update-service --no-cli-pager --cluster helloworld3-cluster --service meeting-bot-3  --force-new-deployment | Out-Null
